...
<h3 className="text-xl font-bold text-green-400 mb-2">Projeto Cadastrado!</h3>
<p className="text-gray-300">
Obrigado por fortalecer a rede. Entraremos em contato em breve para validar as informações.
</p>
<button
...
return (
<form onSubmit={handleSubmit} className="space-y-4 p-4 bg-slate-900/50 rounded-lg border border-slate-700">
<div>
...
<div>
<label className="block text-sm font-medium text-slate-300 mb-1">Organização / Coletivo</label>
<input
type="text"
name="organization"
required
...
<div>
<label className="block text-sm font-medium text-slate-300 mb-1">Área de Atuação</label>
<select
name="area"
value={formData.area}
onChange={handleChange}
...
<div>
<label className="block text-sm font-medium text-slate-300 mb-1">Contato (WhatsApp/Email)</label>
<input
type="text"
name="contact"
required
...
<div>
<label className="block text-sm font-medium text-slate-300 mb-1">Descrição Breve</label>
<textarea
name="description"
required
...
<div>
<label className="block text-sm font-medium text-slate-300 mb-1">Principais Necessidades</label>
<textarea
name="needs"

        ...
        <div className="min-h-screen bg-slate-950 text-white font-sans selection:bg-blue-500/30">
            ...
            <main className="max-w-6xl mx-auto px-6 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-slate-400 max-w-sm">
                                Entre na pele de quem vive nas ruas de Campinas. Enfrente dilemas
                                reais, sobreviva à burocracia e busque a autonomia.
                            </p>
                        </div>
                        <div className="relative z-10 mt-6 flex items-center gap-2 text-blue-400 font-bold uppercase text-sm tracking-widest">
                            Iniciar Jornada <span className="group-hover:translate-x-1 transition-transform">→</span>
                        </div>
                    </Link>
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-slate-400 text-sm">
                                Notícias, denúncias de violência e tradução de leis (Padre Júlio,
                                LOAS) para linguagem acessível.
                            </p>
                        </div>
                    </Link>
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-slate-400 text-sm">
                                Área educativa para Redutores de Danos e Agentes de Saúde. Cursos
                ...
                <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 border-t border-slate-800 pt-8 text-slate-500 text-sm">
                    <div>
                        <h4 className="font-bold text-slate-300 mb-2 flex items-center gap-2"><Shield size={14} /> Dados Seguros</h4>
                        <p>Plataforma em conformidade com LGPD. Seus dados são anônimos e focados em impacto social.</p>
                    </div>
                    <div>
                        <h4 className="font-bold text-slate-300 mb-2 flex items-center gap-2"><MapPin size={14} /> Campinas / SP</h4>
                        <p>Focado na realidade do DDD 019. Dados baseados no Censo Pop Rua 2024.</p>
                    </div>
                    <div>

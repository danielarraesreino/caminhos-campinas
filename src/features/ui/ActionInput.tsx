...
export function ActionInput({ onAction, placeholder = "O que você faz?", isProcessing = false }: ActionInputProps) {
    ...
    return (
        <form onSubmit={handleSubmit} className="p-3 bg-white dark:bg-gray-950 border-t flex gap-2">
            <Button
                type="button"

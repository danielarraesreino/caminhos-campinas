...
import { Mic, Square, Loader2, UploadCloud, CheckCircle2, AlertTriangle } from "lucide-react";
            ...
            <div className="flex flex-col items-center gap-4">
                ...
                {uploadStatus === "success" && (
                    <div className="flex flex-col items-center text-emerald-400 p-4 bg-emerald-950/30 rounded-xl border border-emerald-900/50 w-full animate-in fade-in zoom-in">
                        ...
                        <span className="text-xs opacity-80 text-center mt-1">Sua voz ajuda a mapear a realidade.</span>
                        <button

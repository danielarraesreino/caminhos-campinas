...
export function EffectsLayer() {
	...
	const { health, sanity, activeDilemmaId, phoneBattery } = useGameContext();
	...
	return (
		<div
			className={cn(
				...
				// Low Battery Effect (Static/Flicker)
				batteryLow && "opacity-50 grayscale-[0.5] contrast-75 brightness-75",
			)}
		>
			{batteryLow && (

					...
					<div className="text-center space-y-4">
						...
						<p className="text-slate-400 text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
							...
							<span className="text-white font-bold">
								sobrevivência em situação de rua
							</span>{" "}
							...
							<div className="relative z-10 space-y-5">
								...
								<div>
									...
									<p className="text-violet-200/90 text-sm md:text-base leading-relaxed mb-3">
										...
										que transforma estatísticas em experiência. Cada barreira
										que você enfrenta gera evidência sobre falhas da rede de
										proteção social.
									</p>
							...
							<div className="relative z-10 space-y-5">
								...
								<div>
									...
									<p className="text-yellow-100 font-semibold text-sm md:text-base leading-relaxed mb-3">
										...
										Aprenda rotas, horários e recursos vitais.
										<span className="block mt-1 text-yellow-200/80">
											✓ Funciona 100% offline • ✓ Salva progresso • ✓ Sem
											cadastro
										</span>
									</p>
									<div className="flex flex-wrap gap-1.5">

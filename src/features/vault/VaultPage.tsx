...
<h2 className="text-2xl font-bold mb-4 text-slate-100">🔐 Cofre Digital</h2>
<p className="text-slate-400 mb-8 max-w-sm">
Guarde cópias seguras de seus documentos (RG, CPF, Carteira de Trabalho) no seu Google Drive. 
Assim, mesmo se perder o papel, você tem o arquivo.
</p>
...
<span className="text-2xl">📤</span>
<span className="text-sm font-bold text-green-200">Novo Upload</span>
</button>
</div>

		...
		return (
			<div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-6 text-center">
				...
				<p className="text-slate-400 max-w-sm mb-8">
					Nossa equipe vai analisar sua denúncia/poesia. Se aprovada, ela
					aparecerá no Jornal da Rua.
				</p>
				<Link href="/jornal" className="text-blue-400 hover:underline">
			...
			<div className="max-w-2xl mx-auto px-6 py-8">
				<div className="bg-slate-900/50 p-6 rounded-2xl border border-slate-800 mb-8">
					...
					<p className="text-sm text-slate-400">
						Este espaço é seu. Conte o que a mídia oficial não mostra. Pode ser
						uma denúncia anônima, um poema sobre o frio ou uma história de
						superação.
					</p>
				</div>
				...
				<form onSubmit={handleSubmit} className="space-y-6">
					...
					<div className="flex justify-end gap-3">
						<button
							type="button"
							className="px-4 py-3 bg-slate-800 text-slate-300 rounded-xl font-medium hover:bg-slate-700 transition-colors flex items-center gap-2"
						>

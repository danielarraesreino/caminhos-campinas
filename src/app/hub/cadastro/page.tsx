		...
		return (
			<div className="min-h-screen bg-black flex flex-col items-center justify-center p-6 text-center animate-in fade-in">
				...
				<p className="text-slate-400 mb-8 max-w-sm mx-auto">
					Seus dados foram armazenados no dispositivo e serão sincronizados com
					a rede assim que possível.
				</p>
				<Link href="/">
					<Button
						variant="outline"
			...
			<main className="max-w-xl mx-auto p-6 md:p-10">
				<div className="mb-8">
					...
					<p className="text-slate-400">
						Coletivos, ONGs e Movimentos Sociais: cadastrem-se para aparecer no
						mapa e receber doações diretas.
					</p>
				</div>
				...
				>
					...
					<Button
						type="submit"
						className="w-full h-12 bg-blue-600 hover:bg-blue-700 font-bold uppercase tracking-widest text-sm rounded-xl mt-6"
					>

			...
			<header className="p-6 border-b border-slate-900 sticky top-0 bg-slate-950/90 backdrop-blur-md z-50">
				<div className="max-w-4xl mx-auto flex items-center gap-4">
					...
					<h1 className="text-xl md:text-2xl font-black uppercase tracking-tight">
						Projeto Piloto:{" "}
						<span className="text-green-500">Agilizadores Sociais</span>
					</h1>
				</div>
			</header>
			...
			<div className="max-w-3xl mx-auto px-6 py-12 space-y-16">
				...
				<section className="space-y-6">
					...
					<p className="text-lg text-slate-300 leading-relaxed">
						Baseado nos estudos do neurocientista <strong>Dr. Carl Hart</strong>
						, a metodologia parte de uma premissa científica simples: o vício
						não é uma sentença biológica imutável, mas muitas vezes uma
						adaptação à falta de alternativas de recompensa ("refletores
						alternativos").
					</p>
					<div className="bg-slate-900 border-l-4 border-purple-500 p-6 rounded-r-xl">
						<p className="italic text-slate-400">
							"Quando você oferece alternativas concorrentes atraentes (emprego,
							dinheiro, propósito, conexão social), o uso de drogas cai
							drasticamente."
						</p>
						<span className="block mt-2 text-sm font-bold text-slate-500">
				...
				<section className="space-y-6">
					...
					<p className="text-slate-300">
						Não é caridade. É um contrato de trabalho formativo de curto prazo
						(6 dias). O aluno é tratado como um profissional em treinamento.
					</p>
					...
					<div className="grid md:grid-cols-2 gap-4">
						<div className="bg-[#0c0c0f] border border-slate-800 p-6 rounded-2xl flex flex-col justify-between">
							<div>
								...
								<p className="text-sm text-slate-400">
									Valor pago ao final de cada dia, condicionado 100% à presença
						...
						<div className="bg-[#0c0c0f] border border-slate-800 p-6 rounded-2xl flex flex-col justify-between">
							<div>
								...
								<p className="text-sm text-slate-400">
									Prêmio extra pago na cerimônia de encerramento para quem
									completar o ciclo.
								</p>
							</div>
							<div className="mt-6 text-4xl font-black text-yellow-400">
								R$ 100,00{" "}
								<span className="text-sm text-slate-500 font-normal">
									/ único
								</span>
				...
				<section className="space-y-8">
							...
							<tbody className="divide-y divide-slate-800 text-slate-300">
								<tr className="hover:bg-slate-800/50 transition-colors">
									...
									<td className="px-6 py-4">
										20 alunos x R$ 50 x 8 dias (estimado c/ margem)
									</td>
								...
								<tr className="hover:bg-slate-800/50 transition-colors">
									...
									<td className="px-6 py-4">
										Bolo, Refrigerante, Decoração (CAPS)
									</td>
									<td className="px-6 py-4 text-right font-mono text-slate-400">
										R$ 970,00
									</td>
					...
					<p className="text-xs text-slate-500 text-center italic">
						* Valores estimados com base em cotações locais (Campinas/SP -
						Jan/2026).
					</p>
				</section>

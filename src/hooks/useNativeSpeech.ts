...
export function useNativeSpeech({ onTranscription, onSpeechEnd }: UseNativeSpeechOptions = {}) {
    ...
    const speak = useCallback((text: string) => {
        ...
        const maleVoice = voices.find(v => v.lang.startsWith("pt") && (v.name.toLowerCase().includes("male") || v.name.toLowerCase().includes("google")));
